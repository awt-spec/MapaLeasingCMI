...
const legendItems = [
  { color: "bg-orange-500", label: "Originación" },
          ...
          <StaggerItem key={step.label} className="w-full flex flex-col items-center">
            <motion.div className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-muted/50 border border-border w-full max-w-sm group cursor-grab" whileHover={{ scale: 1.02 }}>
              ...
              <div className="w-7 h-7 rounded-lg bg-orange-500/10 flex items-center justify-center">
                <step.icon className="w-3.5 h-3.5 text-orange-600" />
              </div>
      ...
      <div className="p-5 rounded-2xl bg-card border-2 border-dashed border-border">
        <div className="flex items-center gap-2 mb-3">
          ...
          <div className="ml-auto flex gap-1.5">
            <div className="w-6 h-6 rounded-md bg-orange-500/10 flex items-center justify-center"><Plus className="w-3 h-3 text-orange-500" /></div>
            <div className="w-6 h-6 rounded-md bg-gray-500/10 flex items-center justify-center"><Pencil className="w-3 h-3 text-gray-500" /></div>
    ...
    <SubZoomContainer delay={0.9} direction="bottom">
      <div className="p-5 rounded-2xl bg-orange-500/5 border border-orange-300/30">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { icon: Plus, label: "Agregar", desc: "Nuevos campos y colecciones", color: "text-orange-500" },
            { icon: Pencil, label: "Editar", desc: "Configurar flujos y reglas", color: "text-gray-500" },
            { icon: Layers, label: "Organizar", desc: "Estados y transiciones", color: "text-orange-600" },
          ].map(item => (
